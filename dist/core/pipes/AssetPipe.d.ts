...
export type Tags = CompressTags | MipmapTags | JsonTags | PixiManifestTags | SpineAtlasCompressTags | SpineAtlasMipmapTags | TexturePackerTags | TexturePackerCacheBusterTags | TexturePackerCompressTags | WebfontTags | SignedFontTags | (string & NonNullable<unknown>);
