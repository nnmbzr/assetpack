 ...
 * @returns
 */
export function texturePackerManifestMod(_options = {}) {
    ...
    return {
        ...
        async finish(asset, options, pipeSystem) {
            ...
            const spritesheets = findAssets((asset) => asset.extension === '.json' && asset.allMetaData.tps && asset.transformChildren.length === 0, asset, true);
            ...
            spritesheets.forEach((atlasAsset) => {
                ...
                const textures = Array.isArray(json.meta.image) ? json.meta.image : [json.meta.image];
...
function findAndAddManifestAsset(manifest, assetPath, totalSize) {
...
//# sourceMappingURL=texturePackerManifestMod.js.map