 ...
 * @returns
 */
export function SDFCacheBuster() {
    const fontFilesToFix = [];
    return {
        folder: false,
        ...
        async finish(asset) {
            ...
            for (let i = fntAssets.length - 1; i >= 0; i--) {
                ...
                if (Array.isArray(textures)) {
                    textures.map((txtr) => resetFileName(txtr, fntAsset, asset));
                }
                else {
...
function resetFileName(pack, fntAsset, asset) {
...
//# sourceMappingURL=sdfCacheBuster.js.map